                                    ...
                                    @if($practitionerApplication->accounts == 0)
                                        <div class="text-left mb-4">
                                            <a href="" class="btn btn-success btn-label right ms-auto"><i
                                                ...
                                                Renewal fee: {{$profession_fee = \App\Models\ProfessionFee::where('profession_id', $practitioner_profession_qualification->practitioner_profession->profession->id)
                                                                ->where('register_category_id', $practitioner_profession_qualification->register_category->id)->first()->renewal}}
                                                Checkout</a>
                                        </div>
                                    @endif
                                        ...
                                        <div class="col-6 col-md-4">
                                            <div class="d-flex mt-4">
                                                ...
                                                <div class="flex-grow-1 overflow-hidden">
                                                    ...
                                                    <a href="#"
                                                       class="fw-semibold">
                                                        {{$practitionerApplication->application_status->name}}
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
