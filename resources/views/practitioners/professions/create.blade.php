                ...
                <div class="card" id="tasksList">
                    <div class="card-header border-0">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">Add Professions</h5>
                            <div class="flex-shrink-0">
                                <a href="{{url('/practitioners/professions/'.$practitioner->id.'/index')}}"
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content">
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    ...
                                    <form action="{{url('/practitioners/professions/'.$practitioner->id.'/store')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="mb-3">
                                                        <label for="title"
                                                               class="form-label">Professions</label>
                                                        ...
                                                        @if ($errors->any())
                                                            <span style="color: red;">@error('profession_id'){{$message}}@enderror</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <!--end col-->
