                ...
                <div class="card" id="tasksList">
                    <div class="card-header border-0">
                        <div class="d-flex align-items-center">
                            <h5 class="card-title mb-0 flex-grow-1">Add employment information</h5>
                            <div class="flex-shrink-0">
                                <a href="{{url('/practitioners/employment/'.$practitioner->id.'/index')}}"
                        ...
                        <div class="card-body p-4">
                            <div class="tab-content">
                                <div class="tab-pane active" id="personalDetails" role="tabpanel">
                                    <form method="post" action="{{url('/practitioners/employment/'.$practitioner->id.'/store')}}"
                                                ...
                                                <div class="row g-3">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control" id="contact_person"
                                                               name="contact_person"
                                                               placeholder="Enter company contact person" value="">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="tel" class="form-control" id="company_phone"
                                                               name="company_phone"
                                                               placeholder="Enter company phone number" value="">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="email" class="form-control" id="company_email"
                                                               name="company_email"
                                                               placeholder="Enter company email address" value="">
                                                    </div>
                                                </div>
