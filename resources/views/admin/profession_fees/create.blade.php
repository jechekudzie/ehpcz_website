                        ...
                        <div class="row">
                            ...
                            <div class="media-body text-end">
                                <div class="d-inline-flex">
                                    <a href="{{url('/admin/profession_fees/'.$profession->id.'/index')}}"
                                       class="btn
                                    btn-primary">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select name="register_category_id"
                                                        ...
                                                        @foreach($register_categories as $register_category )
                                                            <option
                                                                value="{{$register_category->id}}">{{$register_category->name}}({{$register_category->description.' '.$register_category->id}})</option>
                                                        @endforeach
